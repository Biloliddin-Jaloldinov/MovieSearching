...
class SearchedMoviesAdapter : ListAdapter<SearchedMovies, SearchedMoviesAdapter.Holder>(Comparator()) {
    ...
    inner class Holder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(item: SearchedMovies) = with(binding) {
    ...
    class Comparator : DiffUtil.ItemCallback<SearchedMovies>() {
        override fun areItemsTheSame(oldItem: SearchedMovies, newItem: SearchedMovies): Boolean {
            return oldItem == newItem
        }

        override fun areContentsTheSame(oldItem: SearchedMovies, newItem: SearchedMovies): Boolean {
